...
country_continent <- read.csv("country_continent.csv")
...
![***Source: UNICEF***](images/UNI341033_0.jpg.jpeg)
...
## Life Expectancy Variation Across Continents

Our exploration now moves forward with a **continental** perspective on **life expectancy** trends over **time**. Through this visualization, we uncover regional patterns and variations in **health** **outcomes**, providing valuable insights into the factors influencing **population health** on a global scale. We'll be looking at the following **continents**:
...
```{r fig.cap= "***Fig 2: Life Expectancy Across Continents*** | The curve depicts the **life expectancy** of various **countries** based on their respective **continents**."}
...
```{r fig.cap= "***Fig 3: Global Health Facility Deliveries Map*** | The map depicts the number of **Deliveries in  a Health Facility** on the basis of various **countries** across the world. Countries in **grey** have no data due to a **mismatch** with their names"}
...
```{r fig.cap= "***Fig 4: Deliveries in Health Facilities vs. GDP per Capita*** | The ***scatter plot*** depicts the **Deliveries in a Health Facility** on the basis of **GDP per Capita** of different **countries** for the **year 2020**, where **Luxembourg** has the highest **deliveries in a health facilities**."}
...
```{r fig.cap= "***Fig 5: Top 15 Countries by Health Facility Deliveries*** | This ***Bar chart*** shows the **Top 15 countries** in terms of **Deliveries in a Health Facility**, and **China** tops the world, with **Estonia** and **Brazil** in the ***2nd*** and ***3rd*** place respectively. "}
...
![***Source: UNICEF***](images/UN0746969.jpg.jpeg)

![](images/Screenshot%202024-04-24%20140057.png)
